                        ...
                        <div class="row table-row">
                                        ...
                                        <div class="card-header table-head">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td><a href="{{route('revenueDetails')}}" style="color:inherit ;">Osborne Estate</a></td>
                                                ...
                                                <tr>
                                                    <td><a href="{{route('revenueDetails')}}" style="color:inherit ;">ChevyView Estate </a></td>
                                                ...
                                                <tr>
                                                    <td><a href="{{route('revenueDetails')}}" style="color:inherit ;">Aerodome GRA </a></td>
