                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">ChevyView Power Management</h4>
                                        <br>
                                        <hr>
                                    </div>
                        ...
                        <div class="row table-row">
                                        ...
                                        <div class="card-header table-head">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <tr>
                                                    <th class="th">Name</th>
                                                    <th class="th">Meter No</th>
                                                    <th class="th">TxRef. ID</th>
                                                    <th class="th">Amount</th>
                                                    
                                                    <th class="th">Unit(kWh)</th>
                                                    <th class="th">Vended Status</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>&#8358;20000</td>
                                                    <td>220</td>
                                                    <td><span class="item-border">Sent</span> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>&#8358;20000</td>
                                                    <td>220</td>
                                                    <td><span class="item-border-2">Awaiting</span> </td>
