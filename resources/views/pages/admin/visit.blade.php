                                            ...
                                            <div class="modal fade" id="exampleModalform1" tabindex="-1" role="dialog">
                                                <div class="modal-dialog modal-dialog-visitorToken" role="document">
                                                    <div class="modal-content modal-content-visitorToken">
                                                        <div class="modal-header modal-visitorToken-header">
                                                            <h5 class="modal-title">Visitor Invite</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-group-visitorToken">
                                                                        <label for="field-3" class="control-label" style="font-family: 'Work Sans'; font-style: normal; font-weight: 600; font-size: 18px; line-height: 21px; color: #303972;">Phone Number</label>
                                                                        <input type="text" class="form-control form-control-visitorToken" id="field-3" placeholder="09041234567">
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-group-visitorToken">
                                                                        <label for="field-4" class="control-label" style="font-family: 'Work Sans'; font-style: normal; font-weight: 600; font-size: 18px; line-height: 21px; color: #303972;">Entry Date</label>
                                                                        <input class="form-control form-control-visitorToken" type="date" value="select" id="example-date-input">
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-group-visitorToken">
                                                                        <label for="field-5" class="control-label" style="font-family: 'Work Sans'; font-style: normal; font-weight: 600; font-size: 18px; line-height: 21px; color: #303972;">Entry Time</label>
                                                                        <input class="form-control form-control-visitorToken" type="time" value="12:00:00" id="example-time-input">
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-group-visitorToken">
                                                                        ...
                                                                        <input type="text" class="form-control form-control-visitorToken" id="field-3" placeholder="2hrs 30mins">
                                                                    </div>
                                                                </div>
