        ...
        <div class="content">
            ...
            <div class="page-content-wrapper ">
                ...
                <div class="container-fluid">
                            ...
                            <!-- Modal HTML -->
                            <div id="myModalserviceFee" class="modal fade">
                                        ...
                                        <div class="card-header table-head">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="th">No of Paid Months</th>
                                                ...
                                                <tbody>
                                                <tr>
                                                    <td> <a href="{{route('serviceFeeDetails')}}" style="color:inherit ;"> ChevyView Estate </a> </td>
                                                ...
                                                <tr>
                                                    <td><a href="{{route('serviceFeeDetails')}}" style="color:inherit ;"> Osborne Estate </a></td>
                                                ...
                                                <tr>
                                                    <td><a href="{{route('serviceFeeDetails')}}" style="color:inherit ;"> Lekky Estate </a></td>
