                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="btn-group float-right-btn ">
                                            ...
                                            <button type="button" onclick="window.location.href=`{{ route('newMessage') }}`" class="btn btn-danger modal-btn-left btn-top" style="background:#FF0808; color:#fff; border-radius: 1rem;" data-toggle="modal" data-target="#exampleModalform2">
                                               New Message
                                            </button>
